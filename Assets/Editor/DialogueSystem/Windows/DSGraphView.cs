...
namespace DS.Windows
{
    ...
    public class DSGraphView : GraphView
    {
        ...
        {
            //Manipulators are classes so if you want to alter their parameters just use the . operator to access them before adding the manipulators
            //to the GraphView. 
            ...
            graphViewChanged = (changes) =>
            {
                ...
                if (changes.elementsToRemove != null)
                {
                    ...
                    foreach (GraphElement element in changes.elementsToRemove)
                    {
                        ...
                        //Just tell me what the contents are before and after we do this shit.
